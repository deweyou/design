...
export const ChiliIcon = /* @__PURE__ */ createIcon('ChiliIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-chili-chili">
        <path
          id="deweyou-icon-tdesign-chili-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-chili-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-chili-stroke1"
          stroke="currentColor"
