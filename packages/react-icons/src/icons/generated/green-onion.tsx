...
export const GreenOnionIcon = /* @__PURE__ */ createIcon('GreenOnionIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-green-onion-green-onion">
        <path
          id="deweyou-icon-tdesign-green-onion-stroke1"
          stroke="currentColor"
