...
export const CloudyRainIcon = /* @__PURE__ */ createIcon('CloudyRainIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-cloudy-rain-cloudy-rain">
        <path
          id="deweyou-icon-tdesign-cloudy-rain-fill2"
          fill="transparent"
        ...
        ></path>
        <g id="deweyou-icon-tdesign-cloudy-rain-stroke2">
          <path
            stroke="currentColor"
            d="M15.5004 11.3333C15.4755 11.3333 15.4506 11.3335 15.4258 11.3339C15.0719 9.30142 13.4937 7.66862 11.4463 7.16283C12.1118 5.878 13.4535 5 15.0004 5C17.2095 5 19.0004 6.79086 19.0004 9C19.0004 10.1467 18.5179 11.1807 17.7448 11.91C17.0842 11.5432 16.3177 11.3333 15.5004 11.3333Z"
        ...
        <path
          id="deweyou-icon-tdesign-cloudy-rain-stroke1"
          stroke="currentColor"
