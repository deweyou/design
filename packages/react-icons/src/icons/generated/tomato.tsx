...
export const TomatoIcon = /* @__PURE__ */ createIcon('TomatoIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-tomato-tomato">
        <path
          id="deweyou-icon-tdesign-tomato-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-tomato-stroke1"
          stroke="currentColor"
