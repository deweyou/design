...
export const BeerIcon = /* @__PURE__ */ createIcon('BeerIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-beer-beer">
        <path
          id="deweyou-icon-tdesign-beer-fill1"
          fill="transparent"
          d="M6.5 22H15.5C16.1828 22 16.5 21.674 16.5 21V19V9H7.5V13C7.5 14.1046 6.60457 15 5.5 15V21C5.5 21.674 5.81718 22 6.5 22Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-beer-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-beer-stroke1"
          stroke="currentColor"
