...
export const TreeRoundDotIcon = /* @__PURE__ */ createIcon('TreeRoundDotIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-tree-round-dot-tree-round-dot">
        <g id="deweyou-icon-tdesign-tree-round-dot-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-tree-round-dot-stroke1"
          stroke="currentColor"
