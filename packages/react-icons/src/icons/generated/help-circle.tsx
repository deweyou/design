...
export const HelpCircleIcon = /* @__PURE__ */ createIcon('HelpCircleIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-help-circle-help-circle">
        <path
          id="deweyou-icon-tdesign-help-circle-fill1"
          fill="transparent"
          d="M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-help-circle-stroke1"
          stroke="currentColor"
          d="M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12Z"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-help-circle-stroke2"
          stroke="currentColor"
