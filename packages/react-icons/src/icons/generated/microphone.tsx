...
export const MicrophoneIcon = /* @__PURE__ */ createIcon('MicrophoneIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-microphone-microphone">
        <g id="deweyou-icon-tdesign-microphone-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-microphone-stroke1"
          stroke="currentColor"
