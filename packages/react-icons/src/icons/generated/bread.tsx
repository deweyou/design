...
export const BreadIcon = /* @__PURE__ */ createIcon('BreadIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g
        id="deweyou-icon-tdesign-bread-bread"
        clipPath="url(#deweyou-icon-tdesign-bread-clip0_543_6550)"
      >
        <path
          id="deweyou-icon-tdesign-bread-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-bread-stroke1"
          stroke="currentColor"
