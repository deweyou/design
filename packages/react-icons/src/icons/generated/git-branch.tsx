...
export const GitBranchIcon = /* @__PURE__ */ createIcon('GitBranchIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-git-branch-git-branch">
        <g id="deweyou-icon-tdesign-git-branch-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-git-branch-stroke1"
          stroke="currentColor"
