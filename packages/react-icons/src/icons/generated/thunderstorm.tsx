...
export const ThunderstormIcon = /* @__PURE__ */ createIcon('ThunderstormIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-thunderstorm-thunderstorm">
        <path
          id="deweyou-icon-tdesign-thunderstorm-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-thunderstorm-stroke2"
          stroke="currentColor"
