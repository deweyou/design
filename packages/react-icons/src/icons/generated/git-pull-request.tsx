...
export const GitPullRequestIcon = /* @__PURE__ */ createIcon('GitPullRequestIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-git-pull-request-git-pull-request">
        <g id="deweyou-icon-tdesign-git-pull-request-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-git-pull-request-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-git-pull-request-stroke2"
          stroke="currentColor"
