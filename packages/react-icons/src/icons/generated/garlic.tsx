...
export const GarlicIcon = /* @__PURE__ */ createIcon('GarlicIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-garlic-garlic">
        <path
          id="deweyou-icon-tdesign-garlic-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-garlic-stroke1"
          stroke="currentColor"
