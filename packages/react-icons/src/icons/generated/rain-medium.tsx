...
export const RainMediumIcon = /* @__PURE__ */ createIcon('RainMediumIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-rain-medium-rain-medium">
        <path
          id="deweyou-icon-tdesign-rain-medium-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-rain-medium-stroke2"
          stroke="currentColor"
