...
export const RainLightFilledIcon = /* @__PURE__ */ createIcon('RainLightFilledIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <path
      ...
      ></path>
      <path fill="currentColor" d="M6.99805 18.998H9.00195V21.002H6.99805V18.998Z"></path>
      <path fill="currentColor" d="M14.998 18.998H17.002V21.002H14.998V18.998Z"></path>
      <path fill="currentColor" d="M13.002 20.998H10.998V23.002H13.002V20.998Z"></path>
    </>
  ),
});
