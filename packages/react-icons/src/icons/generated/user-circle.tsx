...
export const UserCircleIcon = /* @__PURE__ */ createIcon('UserCircleIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-user-circle-user-circle">
        <path
          id="deweyou-icon-tdesign-user-circle-fill1"
          fill="transparent"
          d="M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12Z"
        ></path>
        <g id="deweyou-icon-tdesign-user-circle-fill2">
          <path
            fill="transparent"
        ...
        <g id="deweyou-icon-tdesign-user-circle-stroke2">
          <path
            stroke="currentColor"
            d="M15.5 8.5C15.5 10.433 13.933 12 12 12C10.067 12 8.5 10.433 8.5 8.5C8.5 6.567 10.067 5 12 5C13.933 5 15.5 6.567 15.5 8.5Z"
        ...
        <path
          id="deweyou-icon-tdesign-user-circle-stroke1"
          stroke="currentColor"
          d="M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12Z"
          strokeLinecap="square"
          strokeWidth="2"
