...
export const UserTalkOff1Icon = /* @__PURE__ */ createIcon('UserTalkOff1Icon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-user-talk-off-1-user-talk-off-1">
        <path
          id="deweyou-icon-tdesign-user-talk-off-1-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-user-talk-off-1-stroke2"
          stroke="currentColor"
          d="M21 21L3 3"
          strokeLinecap="square"
          strokeWidth="2"
