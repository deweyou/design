...
export const RainLightIcon = /* @__PURE__ */ createIcon('RainLightIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-rain-light-rain-light">
        <path
          id="deweyou-icon-tdesign-rain-light-stroke1"
          stroke="currentColor"
          ...
          strokeWidth="2"
        ></path>
        <g id="deweyou-icon-tdesign-rain-light-stroke2">
          <path
            stroke="currentColor"
