...
export const AppleIcon = /* @__PURE__ */ createIcon('AppleIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-apple-apple">
        <path
          id="deweyou-icon-tdesign-apple-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-apple-stroke1"
          stroke="currentColor"
