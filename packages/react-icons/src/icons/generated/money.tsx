...
export const MoneyIcon = /* @__PURE__ */ createIcon('MoneyIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-money-money">
        <path
          id="deweyou-icon-tdesign-money-fill1"
          fill="transparent"
          d="M21.5002 11V21H2.5002L2.5002 11L21.5002 11Z"
        ></path>
        <g id="deweyou-icon-tdesign-money-fill2">
          <path
            fill="transparent"
