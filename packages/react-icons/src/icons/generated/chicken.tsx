...
export const ChickenIcon = /* @__PURE__ */ createIcon('ChickenIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-chicken-chicken">
        <path
          id="deweyou-icon-tdesign-chicken-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-chicken-stroke1"
          stroke="currentColor"
