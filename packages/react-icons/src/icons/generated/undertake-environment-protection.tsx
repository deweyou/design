...
export const UndertakeEnvironmentProtectionIcon = /* @__PURE__ */ createIcon(
  'UndertakeEnvironmentProtectionIcon',
  {
    viewBox: '0 0 24 24',
    body: (
      <>
        <g id="deweyou-icon-tdesign-undertake-environment-protection-undertake-environment-protection">
          <path
            id="deweyou-icon-tdesign-undertake-environment-protection-fill1"
            fill="transparent"
          ...
          ></path>
          <g id="deweyou-icon-tdesign-undertake-environment-protection-fill2">
            <path fill="transparent" d="M4.5 15.25V20.5H1V15.25H4.5Z"></path>
            <path
              fill="transparent"
          ...
          <path
            id="deweyou-icon-tdesign-undertake-environment-protection-stroke1"
            stroke="currentColor"
          ...
          ></path>
          <path
            id="deweyou-icon-tdesign-undertake-environment-protection-stroke2"
            stroke="currentColor"
            d="M14 7.5C14 5.0625 17 2 17 2C17 2 20 5.06278 20 7.5C20 9.15685 18.6569 10.5 17 10.5C15.3431 10.5 14 9.15685 14 7.5Z"
            strokeLinecap="square"
            strokeWidth="2"
