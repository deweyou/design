...
export const ListNumberedIcon = /* @__PURE__ */ createIcon('ListNumberedIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <path
      ...
      ></path>
      <path fill="currentColor" d="M7 20V18H22V20H7Z"></path>
      <path fill="currentColor" d="M7 13V11H22V13H7Z"></path>
      <path fill="currentColor" d="M7 6V4H22V6H7Z"></path>
      <path
        fill="currentColor"
