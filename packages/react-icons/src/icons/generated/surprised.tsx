...
export const SurprisedIcon = /* @__PURE__ */ createIcon('SurprisedIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-surprised-surprised">
        <path
          id="deweyou-icon-tdesign-surprised-fill1"
          fill="transparent"
          d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
        ></path>
        <g id="deweyou-icon-tdesign-surprised-fill2">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-surprised-stroke1"
          stroke="currentColor"
          d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
          strokeWidth="2"
        ></path>
        <g id="deweyou-icon-tdesign-surprised-stroke2">
          <path
            stroke="currentColor"
            d="M17 10C17 10.5523 16.5523 11 16 11C15.4477 11 15 10.5523 15 10C15 9.44772 15.4477 9 16 9C16.5523 9 17 9.44772 17 10Z"
