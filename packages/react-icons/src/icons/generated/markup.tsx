...
export const MarkupIcon = /* @__PURE__ */ createIcon('MarkupIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-markup-markup">
        <path
          id="deweyou-icon-tdesign-markup-fill1"
          fill="transparent"
        ...
        ></path>
        <g id="deweyou-icon-tdesign-markup-fill2">
          <path
            fill="transparent"
            d="M7 20.6622C8.47087 21.513 10.1786 22 12 22C13.8214 22 15.5291 21.513 17 20.6622L15 13H9L7 20.6622Z"
          ></path>
          <path fill="transparent" d="M10.9999 9V13H12.9999V9L11.9999 8L10.9999 9Z"></path>
        </g>
        <path
          id="deweyou-icon-tdesign-markup-stroke2"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-markup-stroke1"
          stroke="currentColor"
          d="M22 12C22 15.5058 20.1959 18.5903 17.4654 20.3757C17.3131 20.4753 17.1579 20.5708 17 20.6622C15.5291 21.513 13.8214 22 12 22C10.1786 22 8.47087 21.513 7 20.6622C6.84207 20.5708 6.68687 20.4753 6.53456 20.3757C3.8041 18.5903 2 15.5058 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
          strokeWidth="2"
        ></path>
