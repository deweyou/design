...
export const PearIcon = /* @__PURE__ */ createIcon('PearIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-pear-pear">
        <path
          id="deweyou-icon-tdesign-pear-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-pear-stroke1"
          stroke="currentColor"
