...
export const NoResultFilledIcon = /* @__PURE__ */ createIcon('NoResultFilledIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-no-result-filled-no-result-filled">
        <g id="deweyou-icon-tdesign-no-result-filled-Union">
          <path fill="currentColor" d="M11 0H13V4H11V0Z"></path>
          <path
            fill="currentColor"
