...
export const GestureSlideLeftAndRightIcon = /* @__PURE__ */ createIcon(
  'GestureSlideLeftAndRightIcon',
  {
    viewBox: '0 0 24 24',
    body: (
      <>
        <g id="deweyou-icon-tdesign-gesture-slide-left-and-right-gesture-slide-left-and-right">
          <path
            id="deweyou-icon-tdesign-gesture-slide-left-and-right-fill1"
            fill="transparent"
          ...
          ></path>
          <path
            id="deweyou-icon-tdesign-gesture-slide-left-and-right-stroke1"
            stroke="currentColor"
          ...
          ></path>
          <path
            id="deweyou-icon-tdesign-gesture-slide-left-and-right-stroke2"
            stroke="currentColor"
