...
export const GestureLeftSlipIcon = /* @__PURE__ */ createIcon('GestureLeftSlipIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-left-slip-gesture-left-slip">
        <path
          id="deweyou-icon-tdesign-gesture-left-slip-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-left-slip-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-left-slip-stroke2"
          stroke="currentColor"
