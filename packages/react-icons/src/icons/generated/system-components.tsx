...
export const SystemComponentsIcon = /* @__PURE__ */ createIcon('SystemComponentsIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-system-components-system-components">
        <path
          id="deweyou-icon-tdesign-system-components-fill1"
          fill="transparent"
          d="M11.9994 9.75L15.8484 12V16.5L11.9994 18.75L8.15039 16.5V12L11.9994 9.75Z"
        ></path>
        <g id="deweyou-icon-tdesign-system-components-fill2">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-system-components-stroke1"
          stroke="currentColor"
