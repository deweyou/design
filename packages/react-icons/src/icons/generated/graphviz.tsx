...
export const GraphvizIcon = /* @__PURE__ */ createIcon('GraphvizIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-graphviz-graphviz">
        <g id="deweyou-icon-tdesign-graphviz-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-graphviz-stroke1"
          stroke="currentColor"
