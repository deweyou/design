...
export const FerrisWheelIcon = /* @__PURE__ */ createIcon('FerrisWheelIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-ferris-wheel-ferris-wheel">
        <path
          id="deweyou-icon-tdesign-ferris-wheel-stroke1"
          stroke="currentColor"
