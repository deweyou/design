...
export const Robot1Icon = /* @__PURE__ */ createIcon('Robot1Icon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-robot-1-robot-1">
        <path
          id="deweyou-icon-tdesign-robot-1-fill1"
          fill="transparent"
          d="M6 8C6 5.79086 7.79086 4 10 4H14C16.2091 4 18 5.79086 18 8C18 10.2091 16.2091 12 14 12H10C7.79086 12 6 10.2091 6 8Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-robot-1-stroke1"
          stroke="currentColor"
