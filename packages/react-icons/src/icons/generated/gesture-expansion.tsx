...
export const GestureExpansionIcon = /* @__PURE__ */ createIcon('GestureExpansionIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-expansion-gesture-expansion">
        <path
          id="deweyou-icon-tdesign-gesture-expansion-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-expansion-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-expansion-stroke2"
          stroke="currentColor"
