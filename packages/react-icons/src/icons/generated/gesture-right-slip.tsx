...
export const GestureRightSlipIcon = /* @__PURE__ */ createIcon('GestureRightSlipIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-right-slip-gesture-right-slip">
        <path
          id="deweyou-icon-tdesign-gesture-right-slip-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-right-slip-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-right-slip-stroke2"
          stroke="currentColor"
