...
export const CurtainIcon = /* @__PURE__ */ createIcon('CurtainIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-curtain-curtain">
        <path
          id="deweyou-icon-tdesign-curtain-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-curtain-stroke2"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-curtain-stroke1"
          stroke="currentColor"
