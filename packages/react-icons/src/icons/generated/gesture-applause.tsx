...
export const GestureApplauseIcon = /* @__PURE__ */ createIcon('GestureApplauseIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-applause-gesture-applause">
        <g id="deweyou-icon-tdesign-gesture-applause-fill1">
          <path
            fill="transparent"
        ...
        <g id="deweyou-icon-tdesign-gesture-applause-fill2">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-gesture-applause-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-gesture-applause-stroke2"
          stroke="currentColor"
