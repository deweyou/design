...
export const BambooShootIcon = /* @__PURE__ */ createIcon('BambooShootIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-bamboo-shoot-bamboo-shoot">
        <path
          id="deweyou-icon-tdesign-bamboo-shoot-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-bamboo-shoot-stroke1"
          stroke="currentColor"
