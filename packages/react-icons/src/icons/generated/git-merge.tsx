...
export const GitMergeIcon = /* @__PURE__ */ createIcon('GitMergeIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-git-merge-git-merge">
        <g id="deweyou-icon-tdesign-git-merge-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-git-merge-stroke1"
          stroke="currentColor"
