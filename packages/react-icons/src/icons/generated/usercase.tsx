...
export const UsercaseIcon = /* @__PURE__ */ createIcon('UsercaseIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-usercase-usercase">
        <g id="deweyou-icon-tdesign-usercase-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-usercase-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-usercase-stroke2"
          stroke="currentColor"
