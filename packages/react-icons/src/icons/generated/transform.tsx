...
export const TransformIcon = /* @__PURE__ */ createIcon('TransformIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-transform-transform">
        <g id="deweyou-icon-tdesign-transform-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-transform-stroke1"
          stroke="currentColor"
