...
export const ThunderIcon = /* @__PURE__ */ createIcon('ThunderIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-thunder-thunder">
        <path
          id="deweyou-icon-tdesign-thunder-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-thunder-stroke2"
          stroke="currentColor"
