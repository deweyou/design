...
export const RainHeavyIcon = /* @__PURE__ */ createIcon('RainHeavyIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-rain-heavy-rain-heavy">
        <path
          id="deweyou-icon-tdesign-rain-heavy-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-rain-heavy-stroke2"
          stroke="currentColor"
