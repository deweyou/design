...
export const ForkIcon = /* @__PURE__ */ createIcon('ForkIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-fork-fork">
        <g id="deweyou-icon-tdesign-fork-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-fork-stroke1"
          stroke="currentColor"
