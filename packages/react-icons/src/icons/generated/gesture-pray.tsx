...
export const GesturePrayIcon = /* @__PURE__ */ createIcon('GesturePrayIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-pray-gesture-pray">
        <path
          id="deweyou-icon-tdesign-gesture-pray-fill1"
          fill="transparent"
        ...
        ></path>
        <g id="deweyou-icon-tdesign-gesture-pray-fill2">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-gesture-pray-stroke1"
          stroke="currentColor"
