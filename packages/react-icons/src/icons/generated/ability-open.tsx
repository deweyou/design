...
export const AbilityOpenIcon = /* @__PURE__ */ createIcon('AbilityOpenIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-ability-open-ability-open">
        <path
          id="deweyou-icon-tdesign-ability-open-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-ability-open-stroke1"
          stroke="currentColor"
