...
export const Fingerprint3Icon = /* @__PURE__ */ createIcon('Fingerprint3Icon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-fingerprint-3-fingerprint-3">
        <path
          id="deweyou-icon-tdesign-fingerprint-3-stroke1"
          stroke="currentColor"
