...
export const MapRoutePlanningIcon = /* @__PURE__ */ createIcon('MapRoutePlanningIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-map-route-planning-map-route-planning">
        <path
          id="deweyou-icon-tdesign-map-route-planning-fill1"
          fill="transparent"
          d="M16 7C16 10.25 12 13 12 13C12 13 8 10.2496 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-map-route-planning-fill2"
          fill="transparent"
        ...
        ></path>
        <g id="deweyou-icon-tdesign-map-route-planning-stroke1">
          <path
            stroke="currentColor"
            d="M16 7C16 10.25 12 13 12 13C12 13 8 10.2496 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
            strokeWidth="2"
        ...
        <path
          id="deweyou-icon-tdesign-map-route-planning-stroke2"
          stroke="currentColor"
