...
export const AdjustmentIcon = /* @__PURE__ */ createIcon('AdjustmentIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-adjustment-adjustment">
        <g id="deweyou-icon-tdesign-adjustment-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-adjustment-stroke1"
          stroke="currentColor"
