...
export const TowerClockIcon = /* @__PURE__ */ createIcon('TowerClockIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-tower-clock-tower-clock">
        <path
          id="deweyou-icon-tdesign-tower-clock-fill1"
          fill="transparent"
          d="M18 16H16V22H8V16H6V6H9V3.125L12 2L15 3.125V6H18V16Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-tower-clock-fill2"
          fill="transparent"
          d="M14 11C14 12.1046 13.1046 13 12 13C10.8954 13 10 12.1046 10 11C10 9.89543 10.8954 9 12 9C13.1046 9 14 9.89543 14 11Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-tower-clock-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-tower-clock-stroke2"
          stroke="currentColor"
          d="M14 11C14 12.1046 13.1046 13 12 13C10.8954 13 10 12.1046 10 11C10 9.89543 10.8954 9 12 9C13.1046 9 14 9.89543 14 11Z"
          strokeLinecap="square"
          strokeWidth="2"
