...
export const AiImage1FilledIcon = /* @__PURE__ */ createIcon('AiImage1FilledIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <path
      ...
      ></path>
      <path fill="currentColor" d="M4 13.75H2V11.5H4V13.75Z"></path>
      <path fill="currentColor" d="M22 13.75H20V11.5H22V13.75Z"></path>
      <path
        fill="currentColor"
      ...
      ></path>
      <path fill="currentColor" d="M4 9.75H2V6.5H4V9.75Z"></path>
      <path fill="currentColor" d="M22 9.75H20V6.5H22V9.75Z"></path>
      <path fill="currentColor" d="M4.75 4H4V4.75H2V2H4.75V4Z"></path>
      <path fill="currentColor" d="M22 4.75H20V4H19.25V2H22V4.75Z"></path>
      <path fill="currentColor" d="M10.75 4H7.25V2H10.75V4Z"></path>
      <path fill="currentColor" d="M16.75 4H13.25V2H16.75V4Z"></path>
    </>
  ),
});
