...
export const MeatPepperIcon = /* @__PURE__ */ createIcon('MeatPepperIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-meat-pepper-meat-pepper">
        <path
          id="deweyou-icon-tdesign-meat-pepper-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-meat-pepper-stroke1"
          stroke="currentColor"
