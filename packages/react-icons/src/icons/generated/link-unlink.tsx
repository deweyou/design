...
export const LinkUnlinkIcon = /* @__PURE__ */ createIcon('LinkUnlinkIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-link-unlink-link-unlink">
        <path
          id="deweyou-icon-tdesign-link-unlink-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-link-unlink-stroke2"
          stroke="currentColor"
