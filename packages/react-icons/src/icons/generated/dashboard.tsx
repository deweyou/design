...
export const DashboardIcon = /* @__PURE__ */ createIcon('DashboardIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-dashboard-dashboard">
        <path
          id="deweyou-icon-tdesign-dashboard-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-dashboard-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-dashboard-stroke2"
          stroke="currentColor"
