...
export const ChartRingIcon = /* @__PURE__ */ createIcon('ChartRingIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-chart-ring-chart-ring">
        <path
          id="deweyou-icon-tdesign-chart-ring-fill1"
          fill="transparent"
          ...
          clipRule="evenodd"
        ></path>
        <g id="deweyou-icon-tdesign-chart-ring-fill2">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-chart-ring-stroke1"
          stroke="currentColor"
