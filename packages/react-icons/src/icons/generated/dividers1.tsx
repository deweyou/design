...
export const Dividers1Icon = /* @__PURE__ */ createIcon('Dividers1Icon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-dividers-1-dividers-1">
        <path
          id="deweyou-icon-tdesign-dividers-1-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-dividers-1-stroke1"
          stroke="currentColor"
