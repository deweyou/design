...
export const CherryIcon = /* @__PURE__ */ createIcon('CherryIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g
        id="deweyou-icon-tdesign-cherry-cherry"
        clipPath="url(#deweyou-icon-tdesign-cherry-clip0_543_6572)"
      >
        <g id="deweyou-icon-tdesign-cherry-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-cherry-stroke1"
          stroke="currentColor"
