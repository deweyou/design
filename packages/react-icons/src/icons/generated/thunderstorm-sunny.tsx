...
export const ThunderstormSunnyIcon = /* @__PURE__ */ createIcon('ThunderstormSunnyIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-thunderstorm-sunny-thunderstorm-sunny">
        <path
          id="deweyou-icon-tdesign-thunderstorm-sunny-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-thunderstorm-sunny-stroke2"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-thunderstorm-sunny-stroke1"
          stroke="currentColor"
