...
export const AnimationIcon = /* @__PURE__ */ createIcon('AnimationIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-animation-animation">
        <path
          id="deweyou-icon-tdesign-animation-fill1"
          fill="transparent"
          d="M22 8C22 11.3137 19.3137 14 16 14C12.6863 14 10 11.3137 10 8C10 4.68629 12.6863 2 16 2C19.3137 2 22 4.68629 22 8Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-animation-stroke1"
          stroke="currentColor"
