...
export const ListBugIcon = /* @__PURE__ */ createIcon('ListBugIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-list-bug-list-bug">
        <path
          id="deweyou-icon-tdesign-list-bug-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-list-bug-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-list-bug-stroke2"
          stroke="currentColor"
