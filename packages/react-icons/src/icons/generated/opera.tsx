...
export const OperaIcon = /* @__PURE__ */ createIcon('OperaIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-opera-opera">
        <path
          id="deweyou-icon-tdesign-opera-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-opera-stroke1"
          stroke="currentColor"
