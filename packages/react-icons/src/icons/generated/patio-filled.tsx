...
export const PatioFilledIcon = /* @__PURE__ */ createIcon('PatioFilledIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <path
      ...
      ></path>
      <path fill="currentColor" d="M11 22V20H9V22H11Z"></path>
      <path fill="currentColor" d="M11 18H9V16.5H11V18Z"></path>
      <path fill="currentColor" d="M11 14.5H9V13H11V14.5Z"></path>
    </>
  ),
});
