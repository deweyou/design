...
export const FilePdfFilledIcon = /* @__PURE__ */ createIcon('FilePdfFilledIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <path fill="currentColor" d="M8 15.2496V14.0002L8.75003 14.0001V15.2494L8 15.2496Z"></path>
      <path
        fill="currentColor"
      ...
      ></path>
      <path fill="currentColor" d="M21 14L19 14.0005V15.2497H21V14Z"></path>
    </>
  ),
});
