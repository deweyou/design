...
export const Robot2Icon = /* @__PURE__ */ createIcon('Robot2Icon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-robot-2-robot-2">
        <path
          id="deweyou-icon-tdesign-robot-2-fill1"
          fill="transparent"
          d="M3 14C3 9.58172 6.58172 6 11 6H13C17.4183 6 21 9.58172 21 14C21 18.4183 17.4183 22 13 22H11C6.58172 22 3 18.4183 3 14Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-robot-2-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-robot-2-stroke1"
          stroke="currentColor"
          ...
          strokeWidth="2"
        ></path>
        <g id="deweyou-icon-tdesign-robot-2-stroke2">
          <path
            stroke="currentColor"
            d="M15.9911 16.25H8.00839C7.11543 16.25 6.32454 15.6545 6.27173 14.7631C6.14998 12.7081 6.72828 9.25 11.9997 9.25C17.2711 9.25 17.8495 12.708 17.7277 14.7631C17.675 15.6545 16.8841 16.25 15.9911 16.25Z"
