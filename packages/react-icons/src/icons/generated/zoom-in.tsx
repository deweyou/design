...
export const ZoomInIcon = /* @__PURE__ */ createIcon('ZoomInIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-zoom-in-zoom-in">
        <path
          id="deweyou-icon-tdesign-zoom-in-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-zoom-in-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-zoom-in-stroke2"
          stroke="currentColor"
