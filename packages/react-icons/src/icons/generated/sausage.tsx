...
export const SausageIcon = /* @__PURE__ */ createIcon('SausageIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-sausage-sausage">
        <path
          id="deweyou-icon-tdesign-sausage-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-sausage-stroke1"
          stroke="currentColor"
