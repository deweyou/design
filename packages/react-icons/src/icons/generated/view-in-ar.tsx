...
export const ViewInArIcon = /* @__PURE__ */ createIcon('ViewInArIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-view-in-ar-view-in-ar">
        <path
          id="deweyou-icon-tdesign-view-in-ar-fill1"
          fill="transparent"
          d="M18.0614 8.49977L11.9997 5L5.93836 8.4995L5.9375 15.5L11.9997 19L18.0619 15.5L18.0614 8.49977Z"
        ></path>
        <path
          id="deweyou-icon-tdesign-view-in-ar-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-view-in-ar-stroke2"
          stroke="currentColor"
