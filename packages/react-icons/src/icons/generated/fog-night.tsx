...
export const FogNightIcon = /* @__PURE__ */ createIcon('FogNightIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-fog-night-fog-night">
        <path
          id="deweyou-icon-tdesign-fog-night-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-fog-night-stroke2"
          stroke="currentColor"
