...
export const GestureOpenIcon = /* @__PURE__ */ createIcon('GestureOpenIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-gesture-open-gesture-open">
        <path
          id="deweyou-icon-tdesign-gesture-open-fill1"
          fill="transparent"
        ...
        ></path>
        <g id="deweyou-icon-tdesign-gesture-open-fill2">
          <path
            fill="transparent"
        ...
        <g id="deweyou-icon-tdesign-gesture-open-stroke1">
          <path
            stroke="currentColor"
