...
export const LogoAppleIcon = /* @__PURE__ */ createIcon('LogoAppleIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-logo-apple-logo-apple">
        <g id="deweyou-icon-tdesign-logo-apple-fill1">
          <path
            fill="transparent"
        ...
        <g id="deweyou-icon-tdesign-logo-apple-stroke1">
          <path
            stroke="currentColor"
