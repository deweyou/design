...
export const ImageSearchIcon = /* @__PURE__ */ createIcon('ImageSearchIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-image-search-image-search">
        <path
          id="deweyou-icon-tdesign-image-search-fill2"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-image-search-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-image-search-stroke2"
          stroke="currentColor"
