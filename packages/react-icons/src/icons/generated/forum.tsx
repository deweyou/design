...
export const ForumIcon = /* @__PURE__ */ createIcon('ForumIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-forum-forum">
        <path
          id="deweyou-icon-tdesign-forum-fill1"
          fill="transparent"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-forum-stroke1"
          stroke="currentColor"
          ...
          strokeWidth="2"
        ></path>
        <g id="deweyou-icon-tdesign-forum-stroke2">
          <path
            stroke="currentColor"
