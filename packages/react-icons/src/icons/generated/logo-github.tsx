...
export const LogoGithubIcon = /* @__PURE__ */ createIcon('LogoGithubIcon', {
  viewBox: '0 0 24 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-logo-github-logo-github">
        <path
          id="deweyou-icon-tdesign-logo-github-stroke1"
          stroke="currentColor"
