...
export const AiMusicIcon = /* @__PURE__ */ createIcon('AiMusicIcon', {
  viewBox: '0 0 25 24',
  body: (
    <>
      <g id="deweyou-icon-tdesign-ai-music-ai-music">
        <g id="deweyou-icon-tdesign-ai-music-fill1">
          <path
            fill="transparent"
        ...
        <path
          id="deweyou-icon-tdesign-ai-music-stroke1"
          stroke="currentColor"
        ...
        ></path>
        <path
          id="deweyou-icon-tdesign-ai-music-stroke2"
          stroke="currentColor"
