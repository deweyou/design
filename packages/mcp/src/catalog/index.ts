...
export const componentCatalog: ComponentCatalogItem[] = [
  ...
  },
  {
    ...
    category: 'forms',
    description:
      'Numeric input with placeholder, direct editing, optional localized clear and accessible step controls, locale formatting, and range constraints.',
    dimensions: [
      'size',
      'variant',
      'placeholder',
  ...
  },
  {
    ...
    category: 'content',
    description:
      'Safe CommonMark and GFM rendering surface with visible-by-default YAML frontmatter properties.',
  ...
  {
    name: 'Frontmatter',
    importName: 'Frontmatter',
    category: 'content',
    description:
      'Markdown-native metadata surface with property CRUD, compatible type controls, per-key options, localization, and source recovery.',
    dimensions: [
      'editable',
      'propertyTypes',
      'propertyOptions',
    ...
    subpath: 'frontmatter',
    importSnippet: rootImport('Frontmatter'),
  },
  {
    name: 'Editor',
    importName: 'Editor',
