...
export const lightTheme = {
  ...
  '--ui-color-text-muted': createPaletteCssVar('stone', '700'),
  ...
  '--ui-color-brand-text': createPaletteCssVar('emerald', '900'),
  '--ui-color-text-on-brand': createMonochromeCssVar('white'),
  ...
  '--ui-color-warning-text': createPaletteCssVar('amber', '900'),
  '--ui-color-text-on-warning': createMonochromeCssVar('black'),
  '--ui-color-focus-ring': createPaletteCssVar('emerald', '800'),
...
export const darkTheme = {
  ...
  '--ui-color-text-on-warning': createMonochromeCssVar('black'),
  '--ui-color-focus-ring': createPaletteCssVar('emerald', '700'),
  '--ui-radius-rect': internalPrimitives.radius.rect,
  '--ui-radius-float': internalPrimitives.radius.float,
  '--ui-radius-pill': internalPrimitives.radius.pill,
