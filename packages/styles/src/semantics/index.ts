...
export const publicThemeTokens = [
  ...
  },
  {
    ...
    defaultThemeValue: internalPrimitives.control.heightXs,
  },
  {
    name: 'controlHeightSm',
    cssVar: '--ui-control-height-sm',
    defaultThemeValue: internalPrimitives.control.heightSm,
  },
  {
    name: 'controlHeightMd',
    cssVar: '--ui-control-height-md',
    defaultThemeValue: internalPrimitives.control.heightMd,
  },
  {
    name: 'controlHeightLg',
    cssVar: '--ui-control-height-lg',
    defaultThemeValue: internalPrimitives.control.heightLg,
  },
  {
    name: 'controlHeightXl',
    cssVar: '--ui-control-height-xl',
    defaultThemeValue: internalPrimitives.control.heightXl,
  },
  {
    name: 'touchTargetMin',
  ...
  },
  {
    ...
    defaultThemeValue: internalPrimitives.motion.durationBase,
  },
  {
    name: 'motionDurationSlow',
    cssVar: '--ui-motion-duration-slow',
    defaultThemeValue: internalPrimitives.motion.durationSlow,
  },
  {
    name: 'motionEaseStandard',
    cssVar: '--ui-motion-ease-standard',
    defaultThemeValue: internalPrimitives.motion.easeStandard,
  },
  {
    name: 'motionEaseExit',
    cssVar: '--ui-motion-ease-exit',
    defaultThemeValue: internalPrimitives.motion.easeExit,
  },
  {
    name: 'zDropdown',
    cssVar: '--ui-z-dropdown',
    defaultThemeValue: internalPrimitives.zIndex.dropdown,
  },
  {
    name: 'zTooltip',
    cssVar: '--ui-z-tooltip',
    defaultThemeValue: internalPrimitives.zIndex.tooltip,
  },
  {
    name: 'zPopover',
    cssVar: '--ui-z-popover',
    defaultThemeValue: internalPrimitives.zIndex.popover,
  },
  {
    name: 'zDialog',
    cssVar: '--ui-z-dialog',
    defaultThemeValue: internalPrimitives.zIndex.dialog,
  },
  {
    name: 'zToast',
    cssVar: '--ui-z-toast',
    defaultThemeValue: internalPrimitives.zIndex.toast,
  },
  ...paletteThemeTokens,
